...
const Pricing = () => {
  ...
  return (
    <div id='pricing' className="relative font-inter antialiased">
              ...
              <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-900 shadow shadow-slate-950/5">
                ...
                <ul className="text-slate-600 dark:text-slate-400 text-sm space-y-3 grow">
                  ...
                  <li className="flex items-center">
                    ...
                    <span>Advance Budgeting & Expense Tracking</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
                  ...
                  <li className="flex items-center">
                    ...
                    <span>Automated Bill Payments & Reminder</span>
                  </li>
                </ul>
              </div>
            </div>

            {/* Pricing Tab 2: Perform */}
              ...
              <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-900 shadow shadow-slate-950/5">
                ...
                <ul className="text-slate-600 dark:text-slate-400 text-sm space-y-3 grow">
                  <li className="flex items-center">
                    ...
                    <span>Includes Access to Perks From Previous Level(s)</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
                  ...
                  <li className="flex items-center">
                    ...
                    <span>Premium Reports & Insights</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
                    ...
                    <span>Debt & Loan Management</span>
                  </li>
              ...
              <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-900 shadow shadow-slate-950/5">
                ...
                <ul className="text-slate-600 dark:text-slate-400 text-sm space-y-3 grow">
                  ...
                  <li className="flex items-center">
                    ...
                    <span>Tax Management & Filing Assistance</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
                    ...
                    <span>Premium Customer Care Support</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="w-3 h-3 fill-emerald-500 mr-3 shrink-0"
